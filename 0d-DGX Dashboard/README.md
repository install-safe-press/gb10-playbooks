...
https://docs.nvidia.com/dgx/dgx-spark/  DGX Spark User Guide 
https://forums.developer.nvidia.com/c/accelerated-computing/dgx-spark-gb10/ Nvidia 開發者討論區


2.啟用 JupyterLab 互動式開發環境
